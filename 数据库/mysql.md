...
#### 7. mysql 是如何实现事物的隔离级别的？  (3_2024_12_6)
mysql 通过mvcc多版本控制来实现事物隔离级别，而MVCC多版本并发控制的具体实现依赖读视图和读视图的可见性算法



#### 8. 不同并发场景Mysql是如何解决的？  (3_2024_12_6)
数据库的并发场景有一下三种:
1. 读读，无并发问题
2. 读写，脏读，不可重复读和幻读问题
3. 写写，第一类丢失和第二类丢失问题
...
#### 9. Read View的可见性算法是怎么样的？  (3_2024_12_6)
...
#### 10. MVCC在隔离级别是可重复读时，是如何解决脏读和不可重复读的？  (3_2024_12_6)
