...
#### 10. 什么是sync.once?  (4_2023_10_25)
sync.once 使得函数无论被调用多次，但是只执行一次


#### 11. sync.once的结构体字段？ (4_2023_10_25)
```c++
type Once struct {
    done uint32
    m    Mutex
