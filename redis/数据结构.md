...
// 怎么个高效法要补充
// IO模型需要再看
#### 5.  redis有哪些类型的数据结构？(3_2024_12_15 )
...
#### 7. string类型常用于什么场景？ (3_2024_12_15)
1. key/value 类型缓存数据
2. 计数器、限流，分布式锁

#### 8. list类型支持哪些操作？ (3_2024_12_15)
支持14种操作
...
#### 9. list常见的使用场景？ (3_2024_12_15)
1. 各种链表 -> 粉丝列表、评论列表、文章列表等等

#### 10. set常见的操作？  (3_2024_12_15)
常见的有12种操作
...
#### 11. set常见的场景？ (3_2024_12_15)
1. 求集合交集、差集，并集，两个人共同的好友，两个人不同的好友


#### 12. hash常见的操作？ (3_2024_12_15)
8种常见操作
|  操作     | 命令   | 例子                         | 说明                             | 时间复杂度 |
|  ----    | ----   | ----                        | ----                            | ----    |
...
#### 13. hash常用场景？ (3_2024_12_15)
购物车，用户id: key，商品id => field，数量=> val

#### 14. zset常见的操作？(3_2024_12_15)
支持8种常见操作
...
#### 15. zset常见实用常见？ (3_2024_12_15)
排行榜


#### 16. GEO支持的常见操作？ (3_2024_12_15)
|  操作        | 命令   | 例子                                         | 说明                             | 时间复杂度 |
|  ----       | ----   | ----                                        | ----                             | ----      |
...
#### 18. hyperlonglong 常见操作？ (3_2024_12_15)
|  操作        | 命令   | 例子                                         | 说明                             | 时间复杂度 |
|  ----       | ----   | ----                                        | ----                            | ----      |
...
#### 19. hyperlonglong 的使用场景？ (3_2024_12_15)
较小的内存，求大量数据不同的个数

#### 20. bitmap支持哪些常用操作？(3_2024_12_15)
|  操作         | 命令   | 例子                                         | 说明                             | 时间复杂度 |
|  ----        | ----   | ----                                        | ----                            | ----      |
